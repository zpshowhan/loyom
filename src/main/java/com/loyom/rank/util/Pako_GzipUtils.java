...
public class Pako_GzipUtils {
    ...
    public static void main(String[] args) {
		String data="H4sIAAAAAAAAA03KsRHAMAgEwWquARmJ/xB56L8lOyTbYOmDXmR+OLmH3lRQOWDqwWtgnCskOnGh+AB/1TS5UQAAAA==";
		try {
			System.out.println(URLEncoder.encode(data,"UTF-8"));
			String com=unCompressURI(data);
//			String com=uncompress(data);
